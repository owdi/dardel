...
$req = $bdd->prepare('SELECT * FROM menu WHERE Rubriques=\'SACS, POCHETTES ET RUBANS\' AND langue= :language OR Rubriques=\'BAGS, POUCHES AND RIBBONS\' AND langue= :language');
