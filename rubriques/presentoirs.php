...
$req = $bdd->query('SELECT * FROM menu WHERE Rubriques=\'PRESENTOIRS\'');
$req = $bdd->prepare('SELECT * FROM menu WHERE Rubriques=\'PRESENTOIRS\' AND langue= :language OR Rubriques=\'DISPLAYS\' AND langue= :language');
